...
class Tilemap:
        ...
        for t in data['tilesets']:
            ...
            if 'tileproperties' in t:
                for tile_id in t['tileproperties']:
                    ...
                    if 'PlayerDies' in t['tileproperties'][tile_id] and t['tileproperties'][tile_id]['PlayerDies'] == '1':
                        self.player_dies[int(tile_id)] = True
    ...
    def load_map(self, path):
        ...
        self.current_map = []
        map_data = data['layers'][0]['data2']#CHANGE THIS!
